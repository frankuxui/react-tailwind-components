  ...
  return (
    <>
      <div className='flex flex-col items-center mb-10'>
        <h1 className='text-5xl text-center font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#0076f4] to-[#1ce1ff]'>
          Development Tools
        </h1>
        <p className='docs-lead md:max-w-xl text-center'>
